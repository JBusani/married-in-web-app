    ...
    return (
        <div className={familyStyles.card}>
            <div className={familyStyles.familyContainer}>
                <div className={familyStyles.parentContainer}>{family.headOfHouse.map(parent => (<p className={familyStyles.parent}>{parent}</p>))}</div>
                <div className={familyStyles.familyName}>{family.familyName}</div>
                <div className={familyStyles.childContainer}>{family.children.map(child => ( <p className={familyStyles.child}>{child}</p>))}</div>
            </div>
